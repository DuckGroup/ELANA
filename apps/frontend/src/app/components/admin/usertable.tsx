...
export const UserTable = ({ users, onUserUpdate }: Props) => {
                ...
                <div className="flex gap-2 mt-2">
                  {isEditing ? (
                    ...
                    <button
                      ...
                      className="w-full px-3 py-1.5 bg-stone-100 text-stone-700 text-sm rounded hover:bg-stone-200 transition-colors"
                    >
                      Edit
                    </button>
                  )}
